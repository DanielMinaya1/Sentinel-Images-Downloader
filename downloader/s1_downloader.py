...
class Sentinel1:
    def __init__(self, username, password, footprints_path, orbit_direction,
        ...
        Args:
            ...
            initial_date (str): Start date to download, in "YYYY-MM-DD" format.
            last_date (str): End date to download, in "YYYY-MM-DD" format.
    ...
    def download_product(self, session, SAFE_product):
        """
        Downloads a Sentinel-1 product and its relevant files.
        ...
        Notes:
            ...
            - The folder structure is preserved to match the Sentinel-1 SAFE format.
        """
    ...
    def download_tile(self, tile_id):
        """
        Downloads all Sentinel-1 products for a given AOI across multiple date ranges.

        This method:
        1. Iterates through predefined date ranges.
        2. Constructs a query to fetch available Sentinel-1 products for the tile.
        ...
        Args:
            tile_id (str): The ID of an AOI of interest.
        ...
        for initial_date, last_date in self.date_ranges:
            ...
            for SAFE_product in tqdm(data["value"], desc=desc):
                print()
